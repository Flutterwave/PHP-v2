...
1. [Card](https://github.com/Flutterwave/PHP-v2/wiki/Card-Charge)
2. [Tokenized](https://github.com/Flutterwave/PHP-v2/wiki/Card-Charge#tokenized)
2. [Account](https://github.com/Flutterwave/PHP-v2/wiki/Account-Charge#initiate-a-direct-charge)
3. [Mobile Mobile](https://github.com/Flutterwave/PHP-v2/wiki/Mobile-Money-Payments)
4. [Preauth](https://github.com/Flutterwave/PHP-v2/wiki/Card-Charge#preath)

## Resources

1. [Collection Subaccounts](https://github.com/Flutterwave/PHP-v2/wiki/Collection-Subaccounts)
2. [Transactions](https://github.com/Flutterwave/PHP-v2/wiki/Transactions)
3. [Virtual Account](https://github.com/Flutterwave/PHP-v2/wiki/Virtual-Account)
4. [Virtual Card](https://github.com/Flutterwave/PHP-v2/wiki/Virtual-Card)
5. [Subscriptions](https://github.com/Flutterwave/PHP-v2/wiki/Subscriptions)
6. [Bill](https://github.com/Flutterwave/PHP-v2/wiki/Bill)
7. [Ebill](https://github.com/Flutterwave/PHP-v2/wiki/Ebill)
8. [Refunds](https://github.com/Flutterwave/PHP-v2/wiki/Refund)
